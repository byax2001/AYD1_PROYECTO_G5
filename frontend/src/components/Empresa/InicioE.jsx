...
const InicioE = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_API_CONSUME}/api/products/rest/${state.data.idempresa}`,config); // Reemplaza 'URL_DEL_SERVIDOR' con la URL correcta
